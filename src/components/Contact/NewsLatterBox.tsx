...
const NewsLatterBox = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Pretend to process the subscription
    setIsSubmitted(true);
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Stay updated with the latest tech trends, company news, and exclusive insights from our team of experts.
      </p>
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#8D2CE3" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
