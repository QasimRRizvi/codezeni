...
const servicesData: Service[] = [
  {
    ...
    paragraph:
      "Access top-tier talent across development, QA, project management, and DevOps. Scale your team quickly with our vetted professionals who seamlessly integrate with your existing workflows.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Create powerful, scalable web applications with modern technologies. From responsive websites to complex web platforms, we deliver solutions that drive business growth and user engagement.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Build native and cross-platform mobile applications that deliver exceptional user experiences. Our mobile solutions are designed for performance, scalability, and market success.",
  },
  {
    id: 4,
    icon: (
    ...
    paragraph:
      "Transform your ideas into market-ready products with our MVP development services. We help you validate concepts quickly while maintaining quality and scalability for future growth.",
  },
  {
    id: 5,
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        ...
        />
        <path d="M20 8C13.373 8 8 13.373 8 20C8 26.627 13.373 32 20 32C26.627 32 32 26.627 32 20C32 13.373 26.627 8 20 8ZM20 28C15.582 28 12 24.418 12 20C12 15.582 15.582 12 20 12C24.418 12 28 15.582 28 20C28 24.418 24.418 28 20 28Z" />
      </svg>
    ),
    title: "UI/UX Design",
    paragraph:
      "Create intuitive and engaging user experiences with our expert UI/UX design services. We combine aesthetics with functionality to deliver designs that enhance user satisfaction and drive business results.",
  },
];
