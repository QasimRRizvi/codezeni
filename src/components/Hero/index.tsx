            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base leading-relaxed! text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  CodeZeni delivers cutting-edge IT services including Staff Augmentation, Web Development, Mobile App Development, UI/UX Design, and MVP Development. Partner with us to accelerate your digital transformation journey.
                </p>
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#8D2CE3" stopOpacity="0" />
                <stop offset="1" stopColor="#8D2CE3" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
