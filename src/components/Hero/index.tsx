            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base leading-relaxed! text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  CodeZeni delivers cutting-edge IT services including Staff Augmentation, Web Development, Mobile App Development, and MVP Development. Partner with us to accelerate your digital transformation journey.
                </p>
